...
| ics.redis | object | `{"auth":{"existingSecret":{"keyMapping":{"password":null},"name":null},"password":null,"username":""},"host":"redis-headless","port":"6379","ssl":{"customca":"","enabled":false,"mTLS":{"clientCert":"","clientKey":"","enabled":false,"existingSecret":{"name":"intercom-service-redis-client-credentials"}},"pathCA":"/etc/ssl/certs/redis-custom-CA.pem"}}` | Redis related settings. |
...
| ics.redis.ssl | object | `{"customca":"","enabled":false,"mTLS":{"clientCert":"","clientKey":"","enabled":false,"existingSecret":{"name":"intercom-service-redis-client-credentials"}},"pathCA":"/etc/ssl/certs/redis-custom-CA.pem"}` | Redis SSL/TLS connection settings. |
