...
| ics.logFile | string | `""` | Absolute path of an additional log file to write to. |
| ics.logLevel | string | `"INFO"` | Log level. |
| ics.logVolumeSizeLimit | string | `"1Gi"` | Size limit of the `emptyDir` volume holding the log file. Used only when `ics.logFile` is set. |
...
| provisioning.image | object | `{"imagePullSecrets":[],"pullPolicy":null,"registry":null,"repository":"nubus/images/wait-for-dependency","tag":"0.36.16@sha256:ca3394e7e1cd393e6941822e42a9fbdd59a0a03a0ba772fd9219e661b50f170f"}` | Image of the init container that waits for Keycloak to become available. |
...
| provisioning.image.tag | string | `"0.36.16@sha256:ca3394e7e1cd393e6941822e42a9fbdd59a0a03a0ba772fd9219e661b50f170f"` | Define image tag. |
| provisioning.provisioningImage | object | `{"imagePullSecrets":[],"pullPolicy":null,"registry":null,"repository":"nubus/images/keycloak-bootstrap","tag":"26.7.2-nubus4@sha256:ba88c9c2f1edd30e26a70b0c520b62c374bee0c7d9b78f0a2a9074619aa64f23"}` | Image running the Keycloak bootstrap (univention-keycloak) that provisions the OIDC client. |
...
| provisioning.provisioningImage.tag | string | `"26.7.2-nubus4@sha256:ba88c9c2f1edd30e26a70b0c520b62c374bee0c7d9b78f0a2a9074619aa64f23"` | Define image tag. |
