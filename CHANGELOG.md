...
* **deps:** Update nubus/images/wait-for-dependency Docker tag to v0.36.6 ([8f69d83](https://git.knut.univention.de/univention/dev/projects/intercom-service/commit/8f69d83ad2a5d4b327b93f92bc8160552507a884)), closes [#0](https://git.knut.univention.de/univention/dev/projects/intercom-service/issues/0)

## [2.23.3](https://git.knut.univention.de/univention/dev/projects/intercom-service/compare/v2.23.2...v2.23.3) (2026-02-25)


### Bug Fixes

* **deps:** Update gitregistry.knut.univention.de/univention/dev/projects/ucs-base-image/ucs-base Docker tag to v5.2.4-build.20260224 ([4751237](https://git.knut.univention.de/univention/dev/projects/intercom-service/commit/475123765a75a19bc7f345eb6c167d1ab3aae6d1)), closes [#0](https://git.knut.univention.de/univention/dev/projects/intercom-service/issues/0)
...
* Bump image to errata 299 ([20a2157](https://git.knut.univention.de/univention/dev/projects/intercom-service/commit/20a2157c173fd7aa561298e4150fa2bb1f9c5224)), closes [univention/dev/internal/team-nubus#1518](https://git.knut.univention.de/univention/dev/internal/team-nubus/issues/1518)
